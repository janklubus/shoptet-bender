  ...
  fn: function (req, res, match) {
    ...
    const headerMarkup =
      (fs.existsSync(outputFolder + '/scripts.header.js')
        ? '<script data-type="shp-bender-include" src="/scripts.header.js"></script>'
        : '') +
      (fs.existsSync(outputFolder + '/styles.header.css')
        ? '<link data-type="shp-bender-include" rel="stylesheet" href="/styles.header.css">'
        : '');
  ...
  fn: function (req, res, match) {
    ...
    const footerMarkup =
      (fs.existsSync(outputFolder + '/scripts.footer.js')
        ? '<script data-type="shp-bender-include" src="/scripts.footer.js"></script>'
        : '') +
      (fs.existsSync(outputFolder + '/styles.footer.css')
        ? '<link data-type="shp-bender-include" rel="stylesheet" href="/styles.footer.css">'
        : '');
